...
let p1=Number(prompt("오름 첫번째"))
let p2=Number(prompt("오름 두번째"))
let p3=Number(prompt("오름 세번째"))

let temp2 = 0;
if(p1>p2){ temp2 = p1; p1 = p2; p2 = temp2 }
if(p1>p3){ temp2 = p1; p1 = p3; p3 = temp2 }            // 이거 내가 추가로 넣음,, 흠 맞는지 확인 ㄱㄱ >> ㅇㅇ 맞음
if(p2>p3){ temp2 = p2; p2 = p3; p3 = temp2 }
